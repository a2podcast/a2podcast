...
Questa fase deve produrre anche materia prima editoriale: cambi argomento, passaggi densi e
citazioni brevi verificabili da usare nella sinossi.
...
Produci:
1. Lista delle correzioni nel formato `"testo errato" → "testo corretto" — [motivazione]`.
2. Timeline dei principali cambi argomento nel formato `HH:MM:SS — tema`.
3. 3-8 citazioni candidate nel formato:
   `"citazione breve"` — Nome, HH:MM:SS — perché è utile.

Le citazioni devono essere brevi, con virgolette, riprese dalla trascrizione e corrette solo
per errori evidenti di riconoscimento. Non citare saluti, autopromozione o battute prive di
contenuto.
...
Riporta i timestamp SRT (HH:MM:SS) dei principali cambi argomento e delle citazioni candidate:
servono per i capitoli della sinossi (Fase 3).
```
